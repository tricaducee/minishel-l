...
/*   Updated: 2022/11/04 03:25:44 by hrolle           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// si on nous a pas donne un chemin absolu
// 		build_absolute_path(path, args);
// 	else // si on nous a bien donné /bin/ls,
//			on est pret a executer la commande via execve
// 	{
// 		free(path);
// 		path = NULL;
// 	}
